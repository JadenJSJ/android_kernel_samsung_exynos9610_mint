...
if [[ ! -z ${BUILD_KERNEL_BRANCH} ]]; then
	...
	if [[ ${BUILD_KERNEL_BRANCH} == "mainline" ]]; then
		LOCALVERSION=" - Mint KMask ${KERNEL_BUILD_VERSION}"
		export LOCALVERSION=" - Mint KMask ${KERNEL_BUILD_VERSION}"
		...
		LOCALVERSION=" - Mint KMask Beta ${GITHUB_RUN_NUMBER}"
		export LOCALVERSION=" - Mint KMask Beta ${GITHUB_RUN_NUMBER}"
